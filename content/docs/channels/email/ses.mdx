...
import (
    ...
    "github.com/gopackx/go-notification/channel/mail/ses"
)

notifier.RegisterChannel(ses.New(ses.Config{
    Region:          "us-east-1",
...
| `From`             | `mail.Address` | yes | A verified sender identity (domain or email).                 |
